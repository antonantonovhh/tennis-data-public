...
/* Ширина под самый широкий набор вкладок: без неё блок «Панели» начинался бы
   ...
   Было 318px под пять вкладок (307px). 29.08.2026 у панелей обходчика
   добавилась шестая, «Метод», — запас поднят соответственно. Добавляете
   вкладку — проверьте это число, иначе шапка снова начнёт дёргаться. */
header nav{min-width:378px}
